# Brewnet — Go-Gin Stack

> Go 1.22+ + Gin + GORM + React 19 + Vite 6 + TypeScript
...
|--------|------|----------|---------------------|
| GET | `/` | `{"service":"gin-backend","status":"running","message":"..."}` | Service info / 서비스 정보 |
| GET | `/health` | `{"status":"ok","timestamp":"...","db_connected":bool}` | Healthcheck / 헬스체크 |
| GET | `/api/hello` | `{"message":"Hello from Gin!","lang":"go","version":"..."}` | Hello API |
