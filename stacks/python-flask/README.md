...
DB_DRIVER=sqlite3 SQLITE_PATH=./data/brewnet.db python -m flask --app src.main run --port 8080
```
...
DB_DRIVER=sqlite3 SQLITE_PATH=./data/brewnet.db gunicorn wsgi:app --bind 0.0.0.0:8080 --reload
```
...
| Item | Value |
|------|-------|
| Connection string (container) | `sqlite:////app/data/brewnet.db` |
| Connection string (local) | `sqlite:///./data/brewnet.db` |
